...
# When cross-compiling, clang-tidy needs manual help with the target triple and
# the include paths to find the correct standard library headers.
if(CMAKE_CXX_CLANG_TIDY AND CMAKE_CXX_COMPILER MATCHES .*arm-none-eabi.*)
  ...
  foreach(include ${implicit_includes})
    ...
    # builtins and intrinsics. Clang provides its own so-called resource headers
    # for that purpose, which come bundled with the compiler not the standard
    # library.
